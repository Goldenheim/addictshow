        ...
        <div class="container movieContent">
        	<div class="row col-12 col-md-12">
              ...
              { 
                  ...
                  {
                  ?>
                    <a class="favourite" data-toggle="tooltip" title="Ajouter aux favoris" href="member/favourite-<?php echo $_SESSION['id']; ?>-<?php echo $movie['id']; ?>.html"><i class="far fa-heart"></i></a>
                  <?php
                  } else
                  {
                    ?>
...
<div class="card last-air-episode">
  <div class="p-0 card-body">
    <div class="backdrop-last-air-episode-bloc mx-auto">
      ...
      <?php 
      if($movie['last_episode_to_air']['still_path'] != null) 
      {
      ?>
      ...
      {
      ?>
        <img class="col-lg-4 p-2" src="img/season-episode-404.png">
      <?php 
      }
      ?>
    </div>     
...
<div class="container">
    ...
    {
    ?>
      <a class="btn btn-outline-success text-white" href="member/connexion.php">Connectez-vous pour poster un commentaire</a>
    <?php  
    }  
    ?>
  </div>
          ...
          <h5 class="mt-0 font-weight-bold blue-text"><span class="small">Posté par <strong><?php echo htmlspecialchars($comment['auteur']) ?></strong> le <?php echo $comment['date']->format('d/m/Y à H\hi') ?>
                <div class="btn-group float-right"> 
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="member/comment-update-<?php echo $comment['id'] ?>.html"><i class="fas fa-edit"> Modifier</i></a></li>
                    <li class="nav-item"><a class="nav-link" href="member/comment-delete-<?php echo $comment['id'] ?>.html"><i class="fas fa-trash"> Supprimer</i></a></li>
