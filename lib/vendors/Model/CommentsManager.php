...
abstract class CommentsManager extends Manager
{
  ...
  abstract public function deleteFromNews($news);
   ...
   /**
   * Méthode permettant d'ajouter une réponse à un commentaire
   * @param $comment l'objet commentaire 
   * @param $answer  le contenu de la réponse à enregistrer
   * @return void
   */
  abstract public function answer(Comment $comment, $answer); 

   /**
   * Méthode permettant d'obtenir la liste des réponses.
   * @return ListAnswers
   */
